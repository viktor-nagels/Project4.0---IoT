...
String sensor7;
String banaan;
const char* host = "hooyberghsapi20230117150416.azurewebsites.net"; // only google.com not https://google.com
...
void loop()
{
    ...
    while (LoRa.available())
    {
      ...
      for (int i = 0; i < 12; i++)
      {
        ...
        case 5:
          ...
          banaan = "{\"timestamp\":\"";
          banaan = banaan + formattedDate;
          banaan = banaan + "\",\"value\":";
          banaan = banaan + sensor3;
          banaan = banaan + ",\"wharfID\":43}";
  ...
  if (last_button3_state == HIGH && button3_state == LOW)
  {
    ...
    String url = "/api/FlowRate/addFlowRate";
